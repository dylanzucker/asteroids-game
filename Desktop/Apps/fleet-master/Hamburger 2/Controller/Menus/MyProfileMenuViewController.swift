...
protocol MyProfileMenuVCDelegate: class {
    func MyProfileMenuVCDelegateFunc(someRandomString: String)
}

class MyProfileMenuViewController: UIViewController {
    static let storyboardID = "MyProfileMenuViewController"
    
    weak var delegate: MyProfileMenuVCDelegate?
...
//        delegate?.MyProfileMenuVCDelegateFunc(someRandomString: "tester")
//    }
...
extension MyProfileMenuViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (displayingGroups) {
            ...
            case 1:
                ...
                break
            case 2:
                cell.setLabelText(to: "Settings")
                cell.onClick = {
                    self.dismiss(animated: false, completion: nil)
                    self.delegate?.MyProfileMenuVCDelegateFunc(someRandomString: "tester")
                }
                break
            default:
                break
